...
# برای اطلاع‌رسانی تلگرامی بعد از هر خرید موفق
...
PLANS = {
    1: {"months": 1, "price": 250000},
    3: {"months": 3, "price": 600000},
    6: {"months": 6, "price": 1000000},
    12: {"months": 12, "price": 1700000},
}
...
def payment_callback():
    ...
    if result.get("data") and result["data"].get("code") in (100, 101):
        ...
        # اطلاع‌رسانی به ادمین در تلگرام تا سرور رو به مشتری بده
        notify_admin_telegram(
            "🟢 پرداخت جدید ثبت شد\n"
            f"شماره مشتری: {user.phone}\n"
            f"پلن: {order.plan_months} ماهه\n"
            f"مبلغ: {order.amount_toman:,} تومان\n"
            f"کد پیگیری: {order.ref_id}"
        )
