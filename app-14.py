...
def forex_check_news():
    ...
    # 🔍 حالت تشخیصی: فعلاً فقط نمونه خام جواب رو برای ادمین می‌فرستیم
    # تا فیلدهای واقعی رو ببینیم و بعد فیلترش کنیم
    import json as _json
    raw_preview = _json.dumps(data, ensure_ascii=False, indent=2)[:3500]
    notify_admin_telegram(f"🔍 نمونه خام جواب API فارکس:\n\n{raw_preview}")

    return jsonify({"ok": True, "preview_sent": True})
